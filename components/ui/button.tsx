...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-zinc-100 text-zinc-950 shadow hover:bg-zinc-200 font-semibold",
        destructive:
          "bg-zinc-800 text-zinc-100 shadow-sm hover:bg-zinc-700 border border-zinc-700",
        outline:
          "border border-zinc-800 bg-zinc-950/80 shadow-sm hover:bg-zinc-900 hover:text-zinc-100 hover:border-zinc-700 text-zinc-300",
        secondary:
          "bg-zinc-900 text-zinc-100 shadow-sm hover:bg-zinc-800 border border-zinc-800",
        ghost: "hover:bg-zinc-900 hover:text-zinc-100 text-zinc-400",
